...
discovery_barrier tags: discovery-friction, trust-deficit-new-category, info-gap, risk-aversion, no-need-perceived, habit-lock-in | cues: hard find, poor search, authenticity doubt, missing details, afraid try, not needed, repetitive recommendations
...
unmet_need tags: unmet-need-category, unmet-need-bundling, unmet-need-trust-signal | cues: please add, missing category, combo/bundle, trial size, certification, verified proof
